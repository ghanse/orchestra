...
AGENTIC_TYPES: dict[str, str] = {
    ...
    "Switch": "adf-to-databricks:adf-pipeline-converter",
    "Until": "adf-to-databricks:adf-pipeline-converter",
    "Wait": "adf-to-databricks:adf-pipeline-converter",
    "Filter": "adf-to-databricks:adf-pipeline-converter",
    "AppendVariable": "adf-to-databricks:adf-pipeline-converter",
